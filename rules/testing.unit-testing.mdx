...
description: "Comprehensive guidelines for creating unit tests using Vitest and TypeScript, focusing on critical functionality, dependency mocking, and maintainable test patterns."
category: testing

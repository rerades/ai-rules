...
description: "Standard template and guidelines for creating comprehensive architecture documentation."
category: templates
...
severity: "low"
alwaysApply: false
globs: ["**/architecture.md", "**/ARCHITECTURE.md", "docs/architecture/**/*"]

---
id: foundation.cognitive-load.baseline
version: 1.0.0
title: "Cognitive Load — baseline"
description: "Rules for reducing cognitive load in code: readability, maintainability, and human comprehension."
category: foundation
...
conflicts: []
supersedes: []
bundles: ["baseline/code-quality", "foundation/readability"]
files: ["**/*"]
  ...
  maxComplexity:
    {
      type: "number",
      default: 4,
      description: "Maximum number of concepts in working memory",
    }
  preferEarlyReturns:
    {
      type: "boolean",
      default: true,
      description: "Prefer early returns over nested ifs",
    }
tags: ["topic:cognitive-load", "topic:readability", "topic:maintainability"]
owner: "code-quality@tu-org.com"
review: { lastReviewed: "2025-01-20", reviewCycleDays: 180 }
license: "MIT"
links:
  - { rel: "docs", href: "https://en.wikipedia.org/wiki/Cognitive_load" }
  - {
      rel: "source",
      href: "https://git/org/cursor-rules/rules/general.cognitive-load.mdc",
    }
i18n:
  en:
    {
      title: "Cognitive Load — baseline",
      summary: "Rules for reducing cognitive load in code.",
    }
---
